        ...
        >
            ...
            <div className='person-details'>
                ...
                <div className='person-related-movie-carousel'>
                    <p className='person-biography-header'>Starred in
                        {/* {`${movie.length}`} {movie.length <= 1 ? 'movie' : movie.length === 0 ? null : 'movies'} */}
                    </p>
                            ...
                            movieCast
                                ? movieCast.length > 10
                                    ? <div className='acting-button-container'>
                                        <button onClick={handleShowAllButton}>{showAll ? 'Show Less' : 'Show All'}</button>
                                    </div>
                                    : null
                                : null
                        }
