            ...
            <div className="person-card">
              <div className="person-card-image">
                {item.poster_path ? (
                  ...
                  <img src={dummyImage} alt={item.title} />
                )}
              </div>
  ...
  const handleActingMovieCast = () => {
    return showAll
      ? movieCast
        ? movieCast.map((item) => (
            <div
              className="acting-container-content"
              key={`movieCast${item.id}`}
            >
              <p className="acting-year">
                {item.release_date ? item.release_date.split("-")[0] : "????"}
              </p>
              <p className="acting-title">
                <Link to={`/movie/${item.id}`}>{item.title} </Link>
                <span className="acting-title-span">
      ...
      ? tvCast.map((item) => (
          <div className="acting-container-content" key={`tvCast${item.id}`}>
            ...
            <p className="acting-title">
              ...
              <span className="acting-title-span">
                Episodes {`( ${item.episode_count} )`} as{" "}
    ...
    return (
      <>
        <div className="personal-icons">
          {socialMedia.facebook_id === "" ? null : socialMedia.facebook_id ? (
            <a href={`https://www.facebook.com/${socialMedia.facebook_id}`}>
              <i className="fa-brands fa-facebook"></i>
            </a>
          ) : null}
          {socialMedia.twitter_id === "" ? null : socialMedia.twitter_id ? (
            <a href={`https://www.twitter.com/${socialMedia.twitter_id}`}>
              <i className="fa-brands fa-twitter"></i>
            </a>
          ) : null}
          {socialMedia.instagram_id === "" ? null : socialMedia.instagram_id ? (
            <a href={`https://www.instagram.com/${socialMedia.instagram_id}`}>
              <i className="fa-brands fa-instagram"></i>
            </a>
          ) : null}
          {socialMedia.tiktok_id === "" ? null : socialMedia.tiktok_id ? (
            <a href={`https://www.tiktok.com/${socialMedia.tiktok_id}`}>
              <i className="fa-brands fa-tiktok"></i>
            </a>
          ) : null}
          {socialMedia.youtube_id === "" ? null : socialMedia.youtube_id ? (
    ...
    <div className="person-container">
        ...
        <div className="person-personal-info">
          ...
          <div className="personal-info">
            <div className="personal-info-content">
              ...
              <p className="personal-info-detail">
            ...
            <div className="personal-info-content">
              ...
              <p className="personal-info-detail">
                {data.birthday ? data.birthday.split("-").join(" ") : null}
              </p>
            </div>
            <div className="personal-info-content">
      ...
      <div className="person-details">
        ...
        <div className="person-details-biography">
          ...
          <div className="biography-container">
            <p
              className={
                seeMore
                  ? "person-biography-details-active"
                  : "person-biography-details-default"
              }
            >
              {data.biography
                ? data.biography
        ...
        <div className="person-related-movie-carousel">
          ...
          <div className="related-movie-carousel">{relatedMovieCarousel()}</div>
        </div>
