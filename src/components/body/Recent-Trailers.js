...
const RecentTrailers = () => {
  ...
  const trailerCarouselData = () => {
    return movieTrailerData.map((item) => (
      <div
        className='trailer-card-container'
      ...
      >
        <div className='trailer-card-container-img'>
          ...
          <i
            ...
            onClick={handleYoutubeComponent} id={item.id}
          >
          </i>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <div className='container dynamicBG box-shadow-dark' style={{ ...dynamicBG }}>
        <div className='bg-fade-black'>
          <div className='container'>
            <div className='section'>
              ...
              <div className='recent-trailer'>
                {trailerCarouselData()}
              </div>
            </div>
          </div>
          {state.youtubeComponentID
            ? <YoutubeComponent />
            : null
          }
        </div>
